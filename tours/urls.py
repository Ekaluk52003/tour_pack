...
urlpatterns = [
    ...
    path('save-tour-package/<str:package_reference>/', views.save_tour_package, name='update_tour_package'),
    path('old-list', views.tour_package_list, name='tour_package_list'),
    path('create/', views.tour_package_quote, name='tour_package_quote'),
    path('<str:package_reference>/', views.tour_package_detail, name='tour_package_detail'),
    path('<str:package_reference>/edit/', views.tour_package_edit, name='tour_package_edit'),
